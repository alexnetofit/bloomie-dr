const stats = [
  ...
  { value: "68%", label: "relatam digestão regulada em 14 dias" },
  { value: "59%", label: "notam pele, unha e cabelo melhores em 30 dias" },
];

export function Stats() {
  return (
    <section id="resultados" className="bg-bloom-950 py-16 text-cream-50 md:py-20">
      <div className="container-x">
        <div className="mx-auto mb-10 max-w-2xl text-center">
          ...
          <h2 className="mt-4 font-display text-4xl font-semibold md:text-5xl">
            ...
            <span className="text-bloom-300"> +90.000 besties.</span>
          </h2>
